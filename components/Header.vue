<template>
  ...
  >
    ...
    >
      <nav class="flex flex-col px-6 py-6 gap-4 font-medium">
        <a @click="closeMenu" href="#inicio" class="mobile-link">Inicio</a>
        <a @click="closeMenu" href="#nosotros" class="mobile-link">Quiénes Somos</a>
